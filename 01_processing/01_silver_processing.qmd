...
if USE_LOCAL_PATHS:
    pathlib.Path(SILVER_PATH).mkdir(parents=True, exist_ok=True) # Ensure parent dir exists
...
def read_shapefile_portable(shape_folder_path: str) -> gpd.GeoDataFrame:
    ...
    if USE_LOCAL_PATHS:
        ...
        shp_local = pathlib.Path(shape_folder_path) / "Zonas777.shp" # Assuming a fixed name
