...
\input{secciones/01_descripcion_problema_alternativas}
\input{secciones/02_especificacion_mnl_utilidad}
\input{secciones/03_variables_modelo}
\input{secciones/04_estrategia_estimacion_muestra}
\input{secciones/05_ajuste_convergencia}
\input{secciones/06_parametros_wide}
\input{secciones/07_interpretacion_signos}
\input{secciones/08_decision_modelo_sensibilidades}
